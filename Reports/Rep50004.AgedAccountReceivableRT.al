report 50004 "Aged Accounts Receivable Ret."
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\AgedAccountsReceivableNA_RT.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable For Retention';
    UsageCategory = ReportsAndAnalysis;
    DataAccessIntent = ReadOnly;
    ////LT-25082021 - added Isretention Boolean to show Retention line only.
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                {
                    ...
                    var
                        IntegrationSetup: Record "MTwo Integration Setup";//LT-25082021
                    begin
                        //LT-25082021-start
                        if IsRetention then begin
                            IntegrationSetup.GET;
                            SetFilter("Reason Code", '=%1', IntegrationSetup."Retention Reason Code");
                        end;
                        //LT-25082021-end
                ...
                dataitem(Totals; "Integer")
                {
                    ...
                    begin
                        ...
                        if IsRetention then begin
                            IntegrationSetup.GET;
                            TempCustLedgEntry.SetFilter("Reason Code", '=%1', IntegrationSetup."Retention Reason Code");
                        end;
                        //LT-25082021-end
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(IsRetention; IsRetention)
                    {
                        ApplicationArea = All;
                        Caption = 'Print Retention';
                        Visible = false;
                    }
                }
            }
    ...
    trigger OnPreReport()
    begin
        IsRetention := true;//to Print Retension always
        if Format(PeriodCalculation) <> '' then
    ...
    var
        ...
        IsRetention: Boolean;//LT-25082021
    ...
    begin
        //ExcelBuf.CreateBookAndOpenExcel('', DataLbl, AgedAccountsReceivableLbl, CompanyName(), UserId());//LT-25082021
        //LT-25082021-start

report 50003 "Aged Accounts Receivable LT"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\AgedAccountsReceivableNA.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable LT';
